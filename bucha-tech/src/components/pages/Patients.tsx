                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox 
                            id="edit-ra" 
                            checked={selectedPatient.anesthesie?.alr?.ra ?? false}
                            onCheckedChange={(checked) => setSelectedPatient({
                              ...selectedPatient,
                              anesthesie: {
                                ...selectedPatient.anesthesie,
                                alr: {
                                  ...selectedPatient.anesthesie?.alr,
                                  ra: checked as boolean
                                }
                              }
                            })}
                          />
                          <Label htmlFor="edit-ra">R.A</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox 
                            id="edit-peridural" 
                            checked={selectedPatient.anesthesie?.alr?.peridural ?? false}
                            onCheckedChange={(checked) => setSelectedPatient({
                              ...selectedPatient,
                              anesthesie: {
                                ...selectedPatient.anesthesie,
                                alr: {
                                  ...selectedPatient.anesthesie?.alr,
                                  peridural: checked as boolean
                                }
                              }
                            })}
                          />
                          <Label htmlFor="edit-peridural">Péridural</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox 
                            id="edit-perirachicombine" 
                            checked={selectedPatient.anesthesie?.alr?.perirachicombine ?? false}
                            onCheckedChange={(checked) => setSelectedPatient({
                              ...selectedPatient,
                              anesthesie: {
                                ...selectedPatient.anesthesie,
                                alr: {
                                  ...selectedPatient.anesthesie?.alr,
                                  perirachicombine: checked as boolean
                                }
                              }
                            })}
                          />
                          <Label htmlFor="edit-perirachicombine">Péri-rachi combiné</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox 
                            id="edit-blocPeripherique" 
                            checked={selectedPatient.anesthesie?.alr?.blocPeripherique ?? false}
                            onCheckedChange={(checked) => setSelectedPatient({
                              ...selectedPatient,
                              anesthesie: {
                                ...selectedPatient.anesthesie,
                                alr: {
                                  ...selectedPatient.anesthesie?.alr,
                                  blocPeripherique: checked as boolean
                                }
                              }
                            })}
                          />
                          <Label htmlFor="edit-blocPeripherique">Bloc périphérique</Label>
                        </div>
                      </div>
                    </div>
                    <div>
